...
//             <h2 className="text-[16px] font-bold text-slate-900">Latest Sermons</h2>
//             <button
...
//                 <div
//                   key={i}
//                   className="h-[168px] w-[230px] shrink-0 animate-pulse overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-sm"
//                 >
...
//                 <p className="text-[12px] text-slate-400">No sermons posted yet.</p>
//               </div>
//             ) : (
//               sermons.map((sermon) => (
//                 <button
//                   key={sermon.id}
//                   onClick={() => goTo('/sermons')}
//                   className="w-[230px] shrink-0 overflow-hidden rounded-2xl border border-slate-100 bg-white text-left shadow-sm active:scale-[0.99]"
//                 >
...
//                   </div>
//                   <div className="p-3">
//                     <p className="truncate text-[9px] font-bold uppercase tracking-[0.1em] text-teal-600">
//                       Service Type: {sermon.serviceType}
//                     </p>
//                     <h3 className="mt-1 truncate text-[14px] font-bold text-slate-900">{sermon.title}</h3>
//                     <p className="mt-0.5 truncate text-[11px] text-slate-400">{sermon.preacher}</p>
//                   </div>
//                 </button>
//               ))
//             )}
